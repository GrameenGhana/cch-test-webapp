...
class Facility extends Eloquent {
    ...
    public function users() {
        $rawResult = (array) $DB::select("select u.* from cch_users u inner join cch_facility_user cfu on u.id=cfu.user_id and cfu.primary=1  inner join cch_facilities cf on cfu.facility_id = cf.id where cf.district=$this->id");
