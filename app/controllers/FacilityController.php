...
//         print '<pre>'; print_r($events); print '</pre>';
    ...
    public function create() {
        return View::make('facilities.create', array('districts' => $this->districts, 'facilityTypes' => $this->facilityTypes));
    }
    ...
    public function edit($id) {
        $facility = Facility::find($id);
        return View::make('facilities.edit', array('facility' => $facility, 'districts' => $this->districts, 'facilityTypes' => $this->facilityTypes));
    }
